...
public interface MutableNodeConfig extends NodeConfig {
  ...
  void setPropertyDefConfig(PropertyDefConfig propertyDefConfig);

  void removePropertyDefConfig(String name);

  void setPluginDefConfig(PluginDefConfig pluginDefConfig);

  void removePluginDefConfig(PluginKey pluginKey);
}
