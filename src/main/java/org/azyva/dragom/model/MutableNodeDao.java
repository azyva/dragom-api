...
public interface MutableNodeDao extends Node {
   ...
   */
  OptimisticLockHandle createOptimisticLockHandle();
   ...
   */
  MutableNodeConfig getMutableNodeConfig(OptimisticLockHandle optimisticLockHandle) throws OptimisticLockException;
   ...
   *
   * @param mutableNodeConfig MutableNodeConfig.
   * @param optimisticLockHandle OptimisticLockHandle. Can be null.
   * @throws OptimisticLockException This is a RuntimeException that may be of
   *   interest to the caller.
   ...
   *   interest to the caller.
   */
  void setMutableNodeConfig(MutableNodeConfig mutableNodeConfig, OptimisticLockHandle optimisticLockHandle) throws OptimisticLockException, DuplicateNodeException;
